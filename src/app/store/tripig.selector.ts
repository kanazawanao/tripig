...
export const getCategory = createSelector(selectTripig, fromTripig.getCategory);
...
export const getSelectedCourseId = createSelector(selectTripig, fromTripig.getSelectedCourseId);
